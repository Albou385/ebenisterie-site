...
function Accueil() {
  ...
  return (
    <Container>
      <main>
        {/* Section Hero hors du Container */}
        <section id="hero" className="hero-section" style={{ display: 'flex', alignItems: 'center', gap: '2em', margin: '2em 0', minHeight: '320px' }}>
          <div style={{ flex: '0 1 60%' }}>
            <h1 style={{ marginBottom: "0.5em", color: "#8ac0ff", fontWeight: 700, fontSize: "3em" }}>JS Bouchard Ébénisterie</h1>
            <h2 style={{ marginBottom: "0.5em", color: "#8ac0ff", fontWeight: 600, fontSize: "2.2em" }}>
              Créations uniques en bois massif
            </h2>
            <p style={{ marginBottom: "1.5em", fontSize: "1.15em" }}>
              Spécialisée dans la conception et la fabrication de meubles sur mesure haut de gamme, JS Bouchard Ébénisterie allie savoir-faire traditionnel et créativité contemporaine. Nous réalisons des projets personnalisés, de la restauration d’antiquités à l’aménagement complet de cuisines et salles de bain, en mettant l’accent sur la qualité, la durabilité et l’élégance du bois massif.
            </p>
          ...
          <div style={{ flex: '0 0 260px', display: 'flex', alignItems: 'center', justifyContent: 'center', height: '100%' }}>
            <img
              ...
              style={{ width: '220px', height: '190px', objectFit: 'cover', borderRadius: '0.7em', display: 'block' }}
            />
          </div>
        </section>
